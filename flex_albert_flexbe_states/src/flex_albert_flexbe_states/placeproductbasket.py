...
class PlaceProductBasketState(EventState):
    '''
    ...
    def __init__(self):
        ...
        super(PlaceProductBasketState, self).__init__(outcomes=['placed', 'failed'])
        self._action_topic = "/place_server"
        self._client = ProxyActionClient({self._action_topic: PlaceAction})
        self._placed = False
        self._failed = False
